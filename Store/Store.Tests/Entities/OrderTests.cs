...
namespace Store.Tests.Domain
{
    ...
    public class OrderTests
    {
        ...
        {
            //segundo teste, status do pedido 
            var order = new Order(_customer, 0, null);
        ...
        {
            //terceiro teste, foi pago e esta aguardando entrega
            var order = new Order(_customer, 0, null);
        ...
        {
            //quarto teste, cancelamento do pedido
            var order = new Order(_customer, 0, null);
            order.Cancel();
        ...
        {
            //sexto teste,  adicionando item invalido com quantidade zero
            var order = new Order(_customer, 0, null);
        ...
        {
            //setimo teste, testando o total do pedido
            var order = new Order(_customer, 10, _discount);
            order.AddItem(_product, 5);
            Assert.AreEqual(order.Total(), 50); //resultado tem que dá 50
        }
        ...
        {
            //nono teste, desconto invalido. É preciso ser testado..
